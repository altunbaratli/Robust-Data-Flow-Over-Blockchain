...
router.post("/getState", (req,res) => {
    fabricService.getState(req.body.username, req.body.channel, req.body.smartcontract, req.body.args).then((results) => {
        res.send(results);
        return results;
    });
});
...
router.post("/getAllStates", (req,res) => {
    fabricService.getAllStates(req.body.username, req.body.channel, req.body.smartcontract, req.body.args).then((results) => {
        res.send(results);
        return results;
    });
});
